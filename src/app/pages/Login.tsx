...
import { Eye, EyeOff, ChefHat, AlertCircle, ArrowLeft } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await login(formData.email, formData.password);
       ...
       // After successful login, read latest user from storage to decide where to go
    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="mb-6">
          <Link 
            to="/" 
            className="inline-flex items-center gap-2 px-4 py-2 text-gray-600 hover:text-orange-600 transition-all duration-300 group bg-white hover:bg-orange-50 rounded-full shadow-sm hover:shadow-md border border-gray-200 hover:border-orange-300"
          >
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-gray-600">Sign in to your भान्साSATHI account</p>
        </div>
