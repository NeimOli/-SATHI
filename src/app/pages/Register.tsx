...
import { Eye, EyeOff, ChefHat, AlertCircle, User, Mail, Lock, CheckCircle } from "lucide-react";
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          {success && (
            <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-lg flex items-center gap-3">
              ...
              <div>
                <span className="text-green-700 text-sm font-semibold">Registration Successful!</span>
              ...
              <label htmlFor="terms" className="ml-2 text-sm text-gray-600">
                ...
                <Dialog>
                  ...
                  <DialogContent className="max-w-md max-h-[80vh] overflow-y-auto">
                    <DialogHeader>
                      <DialogTitle>Food Lover Terms of Service</DialogTitle>
                    </DialogHeader>
                    <div className="text-sm text-gray-600 space-y-4">
                      <p>Welcome to भान्साSATHI! By registering as a Recipe Explorer (Food Lover), you agree to the following terms and conditions:</p>
                      <ul className="list-disc pl-5 space-y-2">
                        <li>You will treat all community members with respect.</li>
                        <li>You will not post spam, malicious links, or inappropriate content.</li>
                        <li>Any recipes or content you share must be your own or properly attributed.</li>
                        <li>We reserve the right to suspend accounts that violate these guidelines.</li>
                      </ul>
                      <p>Enjoy exploring, discovering new tastes, and connecting with local chefs!</p>
                    </div>
                  </DialogContent>
                </Dialog>
                {" "}and{" "}
